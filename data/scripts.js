...
exports.BattleScripts = {
	...
	randomSeasonalDimensionalTeam: function () {
		...
		let mons = {
			'Rick': {species: 'alakazam', ability: 'regenerator', item: 'lifeorb', gender: 'M', moves: ['psystrike', 'recover', 'aurasphere', 'watergun']},
			'Morty': {species: 'machop', ability: 'furcoat', item: 'leftovers', gender: 'M', moves: ['bodyslam', 'highjumpkick', 'stockpile', 'outrage']},
			...
			'Scary Terry': {species: 'excadrill', ability: 'baddreams', item: 'earthplate', gender: 'M', moves: ['spore', 'precipiceblades', 'slash', 'dreameater']},
			'Dr. Xenon Bloom': {species: 'reuniclus', ability: 'waterabsorb', item: 'choicespecs', gender: 'M', moves: ['psyshock', 'aurasphere', 'sludgebomb', 'toxic']},
			...
			'Squanchy': {species: 'persian', ability: 'hugepower', item: 'assaultvest', gender: 'M', moves: ['return', 'superpower', 'recover', 'bulkup']},
			...
			'Dipper': {species: 'spinda', ability: 'oblivious', item: 'sitrusberry', gender: 'M', moves: ['machpunch', 'suckerpunch', 'quickattack', 'recycle']},
			'Mabel': {species: 'ralts', ability: 'moody', item: 'brightpowder', gender: 'F', moves: ['protect', 'doubleteam', 'moonblast', 'psychic']},
			'Stanley': {species: 'hitmonchan', ability: 'hugepower', item: 'muscleband', gender: 'M', moves: ['drainpunch', 'bulletpunch', 'closecombat', 'tackle']},
			'Stanford': {species: 'hitmonchan', ability: 'furcoat', item: 'sitrusberry', gender: 'M', moves: ['machpunch', 'suckerpunch', 'dynamicpunch', 'hyperbeam']},
			...
			'Fiddleford McGucket': {species: 'scrafty', ability: 'regenerator', item: 'choiceband', gender: 'M', moves: ['crunch', 'closecombat', 'iciclecrash', 'calmmind']},
			'Time Baby': {species: 'chansey', ability: 'filter', item: 'eviolite', gender: 'N', moves: ['softboiled', 'cottonguard', 'aquaring', 'confusion']},
			'Blendin': {species: 'beheeyem', ability: 'magicguard', item: 'lifeorb', gender: 'M', moves: ['psychic', 'sludgebomb', 'aurasphere', 'partingshot']},
			'Evil Rick': {species: 'alakazam', ability: 'regenerator', item: 'lifeorb', gender: 'M', moves: ['psystrike', 'recover', 'aurasphere', 'watergun'], shiny: true},
			'Evil Morty': {species: 'machoke', ability: 'furcoat', item: 'leftovers', gender: 'M', moves: ['bodyslam', 'highjumpkick', 'stockpile', 'kinesis'], shiny: true},
			...
			'Bill Cipher': {species: 'zapdos', ability: 'magicbounce', item: 'brightpowder', gender: 'N', moves: ['thunderbolt', 'nastyplot', 'recover', 'thunder']},
			"Lil' Gideon": {species: 'Snubbull', ability: 'hugepower', item: 'choiceband', gender: 'M', moves: ['playrough', 'stockpile', 'quickattack', 'earthquake']},
