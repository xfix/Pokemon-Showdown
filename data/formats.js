exports.BattleFormats = {
	...
	'1v1': {
		...
		banlist: ['Soul Dew', 'Memento', 'Explosion', 'Perish Song', 'Destiny Bond', 'Healing Wish', 'Selfdestruct', 'Lunar Dance', 'Final Gambit',
			'Mewtwo', 'Lugia', 'Ho-Oh', 'Blaziken', 'Kyogre', 'Groudon', 'Rayquaza', 'Deoxys', 'Deoxys-Attack', 'Dialga', 'Palkia', 'Giratina', 'Giratina-Origin', 'Darkrai', 'Shaymin-Sky',
	...
	abilityexchange: {
		...
		searchShow: true,
		isTeambuilderFormat: true,
		ruleset: ['Pokemon', 'Ability Exchange Pokemon', 'Ignore Illegal Abilities', 'Sleep Clause Mod', 'Species Clause', 'OHKO Clause', 'Moody Clause', 'Evasion Moves Clause', 'HP Percentage Mod', 'Team Preview'],
		banlist: ['Unreleased', 'Illegal', 'Drizzle ++ Swift Swim', 'Soul Dew', 'Drought ++ Chlorophyll', 'Sand Stream ++ Sand Rush',
	...
	smogondoubles: {
		...
		banlist: ['Illegal', 'Sky Drop', 'Dark Void', 'Soul Dew',
	...
	skybattles: {
		...
		ruleset: ['Pokemon', 'Standard', 'Evasion Abilities Clause', 'Team Preview'],
		banlist: ['Unreleased', 'Illegal', 'Drizzle ++ Swift Swim', 'Soul Dew', 'Iron Ball', 'Gravity', 'Smack Down', 'Skill Swap', 'Entrainment', 'Gastro Acid', 'Simple Beam', 'Worry Seed',
	...
	slowmons: {
		...
		banlist: ['Unreleased', 'Illegal', 'Mewtwo', 'Lugia', 'Ho-Oh', 'Kyogre', 'Groudon', 'Rayquaza', 'Deoxys', 'Deoxys-Attack', 'Deoxys-Defense', 'Deoxys-Speed', 'Dialga', 'Palkia', 'Giratina', 'Giratina-Origin', 'Manaphy', 'Darkrai', 'Shaymin-Sky',
			'Arceus', 'Arceus-Bug', 'Arceus-Dark', 'Arceus-Dragon', 'Arceus-Electric', 'Arceus-Fighting', 'Arceus-Fire', 'Arceus-Flying', 'Arceus-Ghost', 'Arceus-Grass', 'Arceus-Ground', 'Arceus-Ice', 'Arceus-Poison', 'Arceus-Psychic', 'Arceus-Rock', 'Arceus-Steel', 'Arceus-Water',
	...
	stabmons: {
		...
		isTeambuilderFormat: true,
		ruleset: ['Pokemon', 'Standard', 'Evasion Abilities Clause', 'Team Preview'],
		banlist: ['Unreleased', 'Illegal', 'Drizzle ++ Swift Swim', 'Soul Dew',
	...
	gen1ubers: {
		...
		searchShow: true,
		isTeambuilderFormat: true,
		ruleset: ['Pokemon', 'Sleep Clause Mod', 'Species Clause', 'HP Percentage Mod'],
		banlist: ['Illegal']
	},
	gen1uu: {
		name: "[Gen 1] UU",
		...
		debug: true,
		isTeambuilderFormat: true,
		ruleset: ['Pokemon', 'Sleep Clause Mod', 'Species Clause', 'OHKO Clause', 'Evasion Clause', 'Freeze Clause', 'HP Percentage Mod'],
	...
	gen1lc: {
		...
		debug: true,
		isTeambuilderFormat: true,
		ruleset: ['Pokemon', 'Little Cup', 'Sleep Clause Mod', 'Species Clause', 'OHKO Clause', 'Evasion Clause', 'Freeze Clause', 'HP Percentage Mod'],
